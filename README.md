...
Есть regression tests на autosave race, pending save success/error и delete failure flow, но полного тестового покрытия `init/switch/dirty backup/snapshot restore/quota` еще нет.
