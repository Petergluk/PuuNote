...
export const PROSE_CARD = [
  ...
  "prose-code:bg-app-card dark:prose-code:bg-app-card prose-code:px-1 prose-code:rounded",
].join(" ");
...
export const PROSE_FULL = [
  "prose dark:prose-invert max-w-none prose-base",
  "prose-headings:font-serif prose-headings:text-app-text-primary dark:prose-headings:text-app-text-primary",
  ...
  "prose-hr:border-t-2 prose-hr:border-app-border prose-hr:my-4",
  "prose-code:text-app-accent prose-code:bg-app-card dark:prose-code:bg-app-card-hover prose-code:px-1 prose-code:rounded",
].join(" ");
...
export const PROSE_TIMELINE = [
  ...
  "prose-hr:border-t-2 prose-hr:border-app-border prose-hr:my-4",
  "prose-code:text-app-text-primary dark:prose-code:text-app-accent",
  "prose-code:bg-transparent dark:prose-code:bg-transparent prose-code:px-1 prose-code:rounded",
].join(" ");
