...
export const PROSE_CARD = [
  ...
  "prose-h1:text-[2.5em] prose-h2:text-[1.8em] prose-h3:text-[1.35em]",
  "prose-h4:text-[1.15em] prose-h4:opacity-85",
  "prose-h5:text-[0.9em]",
  "prose-h6:text-[0.8em]",
...
export const PROSE_FULL = [
  ...
  "prose-h1:text-[2.6em] prose-h2:text-[1.9em] prose-h3:text-[1.5em]",
  "prose-h4:text-[1.25em] prose-h4:opacity-80",
  "prose-h5:text-[1em]",
  "prose-h6:text-[0.9em]",
