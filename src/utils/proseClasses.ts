...
export const PROSE_BASE = [
  ...
  "prose-headings:font-serif prose-headings:font-medium prose-headings:tracking-normal",
...
export const PROSE_FULL = [
  ...
  "prose-h1:text-[2.2em] prose-h2:text-[1.8em] prose-h3:text-[1.4em]",
  "prose-h4:text-[1.15em] prose-h4:opacity-80",
  "prose-h5:text-[1em]",
  "prose-h6:text-[0.9em]",
...
export const PROSE_TIMELINE = [
  ...
  "prose-h1:text-[1.75em] prose-h2:text-[1.45em] prose-h3:text-[1.2em]",
  "prose-h4:text-[1.05em] prose-h4:opacity-80",
  "prose-h5:text-[0.95em]",
  "prose-h6:text-[0.85em]",
  "prose-code:text-app-text-primary dark:prose-code:text-app-accent",
